...
<!-- Mirrored from www.themeenergy.com/themes/html/social-chef/submit_recipe.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2017 20:21:38 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="wrap clearfix">
			...
			<nav class="user-nav" role="navigation">
				<ul>
					...
					<li class="dark current-menu-item"><a href="submit_recipe.html" title="Submit a recipe"><i class="icon icon-themeenergy_fork-spoon"></i> <span>Submit a recipe</span></a></li>
				</ul>
			</nav>
		</div>
	</header>
