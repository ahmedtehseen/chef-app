...
<!-- Mirrored from www.themeenergy.com/themes/html/social-chef/icons.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2017 20:21:37 GMT -->
<head>
	<meta charset="utf-8">
			...
			<section class="content">
				...
				<div class="row">
					<header class="s-title">
						<h1>2300 Custom font icons</h1>
					</header>
						
					<div class="full-width">
						<img src="https://db.tt/9aqkAgI0" alt="2300 Custom font icons" />
						<img src="https://db.tt/0HHNYzTm" alt="2300 Custom font icons" />
					</div>
				</div>
				<!--//row-->
