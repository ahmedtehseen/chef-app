...
<!-- Mirrored from www.themeenergy.com/themes/html/social-chef/right_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2017 20:21:37 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="wrap clearfix">
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					...
					<li class="current-menu-item"><a href="#" title="Pages"><span>Pages</span></a>
						<ul>
		...
		<div class="wrap clearfix">
			...
			<div class="row">
				<header class="s-title">
					<h1>Page with a right sidebar</h1>
				</header>
				<!--content-->
