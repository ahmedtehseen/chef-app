...
<!-- Mirrored from www.themeenergy.com/themes/html/social-chef/shortcodes.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 23 Jan 2017 20:21:38 GMT -->
<head>
	<meta charset="utf-8">
		...
		<div class="wrap clearfix">
			...
			<nav class="main-nav" role="navigation" id="menu">
				<ul>
					...
					<li class="current-menu-item"><a href="#" title="Features"><span>Features</span></a>
						<ul>
			...
			<section class="content">
				...
				<div class="row">
					<div class="full-width">
						<div class="container box">						
							<h2>Blockquote</h2>
							<blockquote><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.<br /><br /><span>-Jane Doe</span></blockquote>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="full-width">
						<div class="container box">
							...
							<p>Pellentesque pellentesque tempor llentesque <strong>bold text</strong> tempor tellus eget libero llentesque pellentesque <a href="#">link text</a> eget libero tellus ementellentesque tempor <em>emphasized text</em> tellus eget fermentum. usce lacllentesque eget tempor tellus ellenellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellenum.</p>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="full-width">
						<div class="container box">
							<h2>Messages</h2>
							<div class="alert alert-info" role="alert"><button class="close">x</button>Info message box.</div>
							<div class="alert alert-success" role="alert"><button class="close">x</button>Success message box.</div>
							<div class="alert alert-warning" role="alert"><button class="close">x</button>Warning message box.</div>
							<div class="alert alert-danger" role="alert"><button class="close">x</button>Danger message box.</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="full-width">
						<div class="container box">
							...
							<div class="row">
								<div class="one-half">
									<p class="drop-cap">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat eget libero tellus ementellentesque tempor. </p>
								</div>
								<div class="one-half">
									<p class="drop-cap secondary">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat eget libero tellus ementellentesque tempor.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="one-half">
									<ul>
										...
										<li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</li>
										<li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</li>
										<li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy
											<ul>
												<li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</li>
												<li>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy</li>
											</ul>
				...
				<div class="row">
					<div class="full-width">
						<div class="container box">						
							...
							<nav class="tabs">
								<ul>
									<li><a href="#tab1" title="Tab1">Tab 1</a></li>
									<li><a href="#tab2" title="Tab 2">Tab 2</a></li>
									<li><a href="#tab3" title="Tab 3">Tab 3</a></li>
									<li><a href="#tab4" title="Tab 4">Tab 4</a></li>
								</ul>
							</nav>
							<div class="tab-content" id="tab1"><h6>Tab1</h6> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.</p></div>
							<div class="tab-content" id="tab2"><h6>Tab2</h6> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellus. Phasellus pharetra nulla ac diam.</p></div>
